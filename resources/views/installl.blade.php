            ...
            <div class="card">
                <div class="card-body">
                    <div class="app-brand justify-content-center">
                        <a href="{{ url('install') }}" class="app-brand-link gap-2">
                                        ...
                                        <input type="hidden" name="redirect_url" value="{{ url('/') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-password-toggle mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input class="form-control" type="password" id="password" name="password" placeholder="Please enter admin password" autocomplete="new-password">
                                                ...
                                                <div class="form-password-toggle mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input class="form-control" type="password" id="password_confirmation" name="password_confirmation" placeholder="Please re enter admin password" autocomplete="new-password">
                                                        <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                                    </div>
                                                </div>
                                                <div class="mt-2 text-center">
