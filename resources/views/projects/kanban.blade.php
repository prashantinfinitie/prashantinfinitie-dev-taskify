...
<div class="container-fluid">
    ...
    @endphp
    <x-projects-kanban-card :projects="$projects" :statuses="$statuses" :showSettings="$showSettings" :canEditProjects="$canEditProjects" :canDeleteProjects="$canDeleteProjects" :canDuplicateProjects="$canDuplicateProjects" :webGuard="$webGuard" :customFields="$projectCustomFields" />
    @else
    <?php $type = 'projects'; ?>
