        ...
        <div class="card-body">
            <form action="{{url('settings/store_security')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="max_files" class="form-label"><?= get_label('max_files_allowed', 'Max Files Allowed') ?></label>
                        <i class='bx bx-info-circle text-primary' data-bs-toggle="tooltip" data-bs-placement="top" title="<?= get_label('max_files_allowed_info', 'Set the maximum number of files that can be uploaded at a time. Also, set the `max_file_uploads` PHP configurations on your server accordingly to ensure the Max Files Allowed works as expected.') ?>"></i>
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="allowed_file_types" class="form-label"><?= get_label('allowed_file_types', 'Allowed File Types') ?></label>
                        <i class='bx bx-info-circle text-primary' data-bs-toggle="tooltip" data-bs-placement="top" title="<?= get_label('allowed_file_types_info', 'Specify the file types allowed for upload, separated by commas. Default: .pdf, .doc, .docx, .png, .jpg, .xls, .xlsx, .zip, .rar, .txt.') ?>"></i>
