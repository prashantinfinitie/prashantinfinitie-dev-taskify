                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-items-center">
                                <div class="d-flex">
                                    <a href="{{ url('/roles/edit/' . $role->id) }}" class="card-link"><i class='bx bx-edit mx-1'></i></a>
                                    <a href="javascript:void(0);" type="button" data-id="{{$role->id}}" data-type="roles" data-reload="true" class="card-link mx-4 delete"><i class='bx bx-trash text-danger mx-1'></i></a>
                                </div>
                            </td>
                            @endif
                        </tr>
